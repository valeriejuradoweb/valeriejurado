  ...
  return (
    <>
      ...
      {slice.variation === "1Video3Images" && (
        <section className="bg-white overflow-hidden py-4 md:py-8">
          <div className="block pt-0 md:absolute md:right-0 md:pt-8">
            <PrismicNextImage
          ...
          <div className="space-y-8 block md:space-y-0 md:gap-10 md:flex md:z-10">
            <PrismicNextLink field={slice.primary.videolink}>
              {prismic.isFilled.linkToMedia(slice.primary.video_1) && (
                <video
                  playsInline
                  autoPlay
